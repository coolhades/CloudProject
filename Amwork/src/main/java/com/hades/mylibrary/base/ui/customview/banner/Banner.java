package com.hades.mylibrary.base.ui.customview.banner;
...
import com.hades.mylibrary.base.ui.customview.banner.loader.ImageLoaderInterface;
import com.hades.mylibrary.base.ui.customview.banner.view.BannerViewPager;
...
public class Banner extends FrameLayout implements OnPageChangeListener {
    ...
    public Banner(Context context) {
        this(context, null);
        Log.d("TAG-BannerCon", "1");
    }

    public Banner(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        Log.d("TAG-BannerCon", "2");
    }
    ...
    public Banner setIndicatorSize(int width, int height){

...
import com.hades.mylibrary.cloud.biz.bizbase.BaseSortView;
import com.hades.mylibrary.cloud.biz.bizbase.BizSortView;
import com.hades.mylibrary.cloud.biz.bizroot.ILoadData;
import com.hades.mylibrary.cloud.biz.bizroot.RootViewActivity;
...
public class ClassViewActivity extends RootViewActivity {
    ...
    private void initRecycler(final List<Map<String, String>> list) {
        adapter = new CommonAdapter<Map<String, String>>(ClassViewActivity.this, R.layout.item_recycler_sortcontent, list) {
            @Override
